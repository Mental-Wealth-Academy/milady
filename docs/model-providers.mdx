...
| [Ollama](https://ollama.com) | `@elizaos/plugin-ollama` | `OLLAMA_API_ENDPOINT` | Bundled | **Local models.** No API key needed. Requires a running [Ollama](https://ollama.com) server. |
...
Ollama auto-enables as soon as `OLLAMA_API_ENDPOINT` is set. If you are running Ollama on the default port locally, just set:
