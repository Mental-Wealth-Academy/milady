...
| [Local AI](https://github.com/elizaos-plugins/plugin-local-ai) | `@elizaos/plugin-local-ai` | — | On demand | **Local models.** Downloads and runs GGUF models directly — no external server required. |
