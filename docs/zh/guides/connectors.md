...
description: "30 个消息和代理平台的平台桥接器 — 18 个通过配置自动启用（Discord、Telegram、Slack、WhatsApp、Signal、iMessage、Blooio、MS Teams、Google Chat、Twitter、Farcaster、Twitch、Mattermost、Matrix、Feishu、Nostr、Lens、WeChat），另有 12 个可从注册表安装（ACP、BlueBubbles、Bluesky、Instagram、LINE、Zalo、Zalo User、Twilio、GitHub、Gmail Watch、Nextcloud Talk、Tlon）。"
---
