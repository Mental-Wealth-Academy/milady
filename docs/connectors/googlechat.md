...
These can be set instead of (or alongside) the JSON config:
...
| `GOOGLE_APPLICATION_CREDENTIALS` | Standard Google credential file path or JSON |
| `GOOGLE_CHAT_AUDIENCE_TYPE` | Authentication audience type |
...
| `GOOGLE_CHAT_SPACES` | Comma-separated space/room IDs |
