...
<Card title="Platform Connectors" icon="plug" href="/plugin-registry/platform/discord">
  Bridges to 28+ messaging and social platforms (Discord, Telegram, Twitter, Slack, WhatsApp, Signal, iMessage, Blooio, MS Teams, Google Chat, Mattermost, Farcaster, Twitch, Feishu, Matrix, Nostr, WeChat, BlueBubbles, Bluesky, Instagram, LINE, Zalo, Twilio, GitHub, Gmail Watch, Nextcloud Talk, Tlon, ACP). Connectors auto-enable when their credentials are configured.
</Card>
